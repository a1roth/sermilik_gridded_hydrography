function objmap_2017(xcor1,ycor1,a1,xcor2,ycor2,a2,noise,xres,yres,xstart,xend,ystart,yend,notes)
...
load('sf2017_input_profiles.mat')
...
%or as netcdf
% lat = ncread('sf2017_input_profiles.nc','lat');
% lon = ncread('sf2017_input_profiles.nc','lon');
% CT = ncread('sf2017_input_profiles.nc','CT');
% SA = ncread('sf2017_input_profiles.nc','SA');
% station = ncread('sf2017_input_profiles.nc','stationID');
% dist_plot = ncread('sf2017_input_profiles.nc','distance');
% time = ncread('sf2017_input_profiles.nc','time');
...
whichcasts = [1,2,4, 5, 6,9,10]; %%which rows are deep enough to be extended. CHANGE THIS AS NEEDED FOR YOUR SPECIFIC SITE/YEAR. 
...
%% CREATE OBJECTIVE MAP FOR 2017 TEMPERATURE

%Make objective map
[objmap,errmap,residuals_mat,XG,YG] = objmap_from_profiles('2017T',xx2,depth2,TempData,xg,yg,background_CT,xback,yback,xcor1,ycor1,a1,xcor2,ycor2,a2,noise);

%% save objective map outputs into structure
grids2017.T.objmap = objmap;
grids2017.T.errmap = errmap;
grids2017.T.residuals = residuals_mat;
grids2017.T.xg = XG;
grids2017.T.yg = YG;

%save input data into structure
grids2017.T.data = TempData;
grids2017.T.xdata = xx2;
grids2017.T.ydata = depth2;
grids2017.T.latdata = lat;
grids2017.T.londata = lon;
grids2017.T.dist = dist_plot;

%Want some way to save non-bottomfilled points to data CT_plot
grids2017.T.data_raw = CT';
grids2017.T.lat_raw = lat_raw;
grids2017.T.lon_raw = lon_raw;
...
[objmap,errmap,residuals_mat,XG,YG] = objmap_from_profiles('2017S',xx2,depth2,SalData,xg,yg,background_SA,xback,yback,xcor1,ycor1,a1,xcor2,ycor2,a2,noise);

%% Save salinity outputs into structure
grids2017.S.objmap = objmap;
grids2017.S.errmap = errmap;
grids2017.S.residuals = residuals_mat;
grids2017.S.xg = XG;
grids2017.S.yg = YG;
%save input data into structure
grids2017.S.data = SalData;
grids2017.S.xdata = xx2;
grids2017.S.ydata = depth2;
grids2017.S.latdata = lat;
grids2017.S.londata = lon;
grids2017.S.dist = dist_plot;


%Want some way to save non-bottomfilled points to data SA_plot
grids2017.S.data_raw = SA';
grids2017.S.lat_raw = lat_raw;
grids2017.S.lon_raw = lon_raw;
...
[objmapT_corr,residualsT_corr] = correctFreezing(grids2017.T.objmap,grids2017.S.objmap,grids2017.T.xg,grids2017.T.yg,grids2017.T.data,grids2017.T.xdata,grids2017.T.ydata,lat(1));

%save objective map outputs into structure
grids2017.T.objmap = objmapT_corr;
grids2017.T.residuals = residualsT_corr;
...
grids2017.T.errmap_stdgrid = interp2(grids2017.T.xg,grids2017.T.yg,grids2017.T.errmap,Xq,Yq);
grids2017.S.errmap_stdgrid = interp2(grids2017.S.xg,grids2017.S.yg,grids2017.S.errmap,Xq,Yq);

grids2017.T.objmap_stdgrid = interp2(grids2017.T.xg,grids2017.T.yg,grids2017.T.objmap,Xq,Yq);
grids2017.S.objmap_stdgrid = interp2(grids2017.S.xg,grids2017.S.yg,grids2017.S.objmap,Xq,Yq);

grids2017.T.Xq_stdgrid = Xq;
grids2017.S.Xq_stdgrid = Xq;

grids2017.T.Yq_stdgrid = Yq;
grids2017.S.Yq_stdgrid = Yq;

grids2017.notes = notes;
% 
...
grids2017.parameteres = parameters;

grids2017.raw_profile_stationID = station;
grids2017.raw_profile_date = time;
grids2017.lat_raw = lat_raw;
grids2017.lon_raw = lon_raw;

save('grids2017.mat','grids2017')
disp('grids2017 saved')
